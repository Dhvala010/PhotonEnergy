...
esc_html__('OT Recent Posts', 'industris'), 

// Widget description

array( 'description' => esc_html__( 'OT Recent Posts', 'industris' ), ) 
...
public function widget( $args, $instance ) {
    ...
    $title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Latest News', 'industris' ) : $instance['title'], $instance, $this->id_base );
            ...
            <li class="clearfix <?php if( !has_post_thumbnail() ) echo "not-thumb"; ?>"> 
                ...
                <div class="thumb">
                    <a href="<?php the_permalink(); ?>">
                        <?php the_post_thumbnail( 'industris-recent-post-thumbnail' ); ?>
                    </a>
                </div>
                <?php } ?>
...
// Check values
	 ...
	 $title = isset( $instance['title'] ) ? $instance['title'] : esc_html( 'Latest News', 'industris' );
...
<p>
    <label><?php esc_html_e( 'Title:', 'industris' ); ?></label>

    <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
</p>
<p>

    <label><?php esc_html_e( 'Number of posts to show:', 'industris' ); ?></label> 
...
<p>
    <label>
        ...
        <?php esc_html_e( 'Show date time', 'industris' ); ?>
    </label>
</p>
