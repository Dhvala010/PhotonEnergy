 ...
 */
class Industris_FeaturedProjects extends Widget_Base{
	...
	public function get_title() {
		return __( 'Industris Featured Portfolio', 'industris' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .project-item .project-info' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .project-item .project-info' => 'background: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		if( $settings['plist'] )
			$num = -1;
		?>
		<div class="featured-projects-wraper">
			<div class="featured-projects iarrow <?php if( $settings['pos_nav'] == 'mid' ) echo 'arrow-s2'; ?>" data-arrow="<?php echo $settings['tarrow']; ?>" data-dots="<?php echo $settings['tdots']; ?>">
				<?php 
				...
				<div class="project-item relative">
	                ...
	                <div class="project-info">
	                    ...
	                    <?php if( $settings['show_exc'] ) echo '<p>'.industris_excerpt($settings['exc_num']).'</p>'; ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Industris_FeaturedProjects() );